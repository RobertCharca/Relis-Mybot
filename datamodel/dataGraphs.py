...
from countData import readDatabase

print("¿Desea mostrar los datos recogidos del chatbot?")
answer = input("Escriba si o no: ")
...
class DataBase:
    ...
    def update(self):
        ...
        if id_pregunta==100:
            ...
            datos1 = "SELECT Id_Respuesta, Respuesta FROM Respuestas WHERE Id_Pregunta = 100"
            data = pd.read_sql(datos1, database.connection)
            print(data)
            ...
            if id_pregunta==101:
                ...
                datos1 = "SELECT Id_Respuesta, Respuesta FROM Respuestas WHERE Id_Pregunta = 101"
                data = pd.read_sql(datos1, database.connection)
                print(data)
                ...
                if id_pregunta==102:
                    ...
                    datos1 = "SELECT Id_Respuesta, Respuesta FROM Respuestas WHERE Id_Pregunta = 102"
                    data = pd.read_sql(datos1, database.connection)
                    print(data)
                    ...
                    if id_pregunta==103:
                        ...
                        datos1 = "SELECT Id_Respuesta, Respuesta FROM Respuestas WHERE Id_Pregunta = 103"
                        data = pd.read_sql(datos1, database.connection)
                        print(data)
                        ...
                        if id_pregunta==104:
                            ...
                            datos1 = "SELECT Id_Respuesta, Respuesta FROM Respuestas WHERE Id_Pregunta = 104"
                            data = pd.read_sql(datos1, database.connection)
                            print(data)
